...
#include "dcmjp2k/djencode.h" /* for class DJLSEncoderRegistration */
#include "dcmjp2k/djrparam.h" /* for class FMJP2KRepresentationParameter */
...
int main(int argc, char *argv[]) {
    ...
    cmd.addOption("--PSNR", "+ps", 1, "[s]ize: integer (default: 0 (automatic))", "set JPEG-2000 encoding parameter psnr");
    cmd.addOption("--cblkwidth", "+cw", 1, "[s]ize: integer (default: 64)", "set JPEG-2000 encoding parameter code block size");
    cmd.addOption("--cblkheight", "+ch", 1, "[s]ize: integer (default: 64)", "set JPEG-2000 encoding parameter code block size");
    ...
    cmd.addOption("--fragment-size", "+fs", 1, "[s]ize: integer", "limit fragment size to s kbytes");
