 ...
 */
class DCMJP2K_EXPORT DcmJp2kRepresentationParameter : public DcmRepresentationParameter {
   public:
    /** constructor
     ...
     */
    DcmJp2kRepresentationParameter(Uint16 PSNR = 0, OFBool losslessProcess = OFTrue);

    /// copy constructor
    DcmJp2kRepresentationParameter(const DcmJp2kRepresentationParameter &arg);

    /// destructor
    virtual ~DcmJp2kRepresentationParameter();
